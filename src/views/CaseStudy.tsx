  ...
  return (
    <>
      <SEOHead
        ...
        description={project.description || `Learn how we helped ${project.title} achieve their digital goals. View our case study showcasing our ${project.category} expertise.`}
