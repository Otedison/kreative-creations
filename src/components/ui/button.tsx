  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        coral: "bg-gradient-coral text-accent-foreground shadow-coral hover:shadow-glow hover:-translate-y-0.5",
        "coral-outline": "border-2 border-accent bg-transparent text-accent hover:bg-accent hover:text-accent-foreground",
        hero: "bg-gradient-coral text-accent-foreground shadow-coral hover:shadow-glow hover:-translate-y-1 hover:scale-[1.02]",
        ...
        dark: "bg-slate-dark text-primary-foreground hover:bg-slate-medium shadow-soft hover:shadow-medium",
      },
      size: {
